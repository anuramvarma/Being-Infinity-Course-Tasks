...
public class TicTacToe {
    ...
    private void setupGame() {
        ...
        System.out.println("\nGame setup completed succsfully!");
    ...
    private GameResult runMatch() {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (board[row][col] != ' ') {
                    System.out.println("Entered Cell is already occupied.");
                    continue;
                }
    ...
    private void displaySummary(GameResult r) {
        ...
        if (r.isWin)
            System.out.println("The Winner is : " + r.winnerName);
        else
            System.out.println("RESULT: DRAW");

        System.out.println("Total_Moves: " + r.totalMoves);
        System.out.println(playerNames[0] + ": " + r.perPlayerMoves[0]);
        System.out.println(playerNames[1] + ": " + r.perPlayerMoves[1]);
        //System.out.println("Played Duration: " + r.durationSeconds + " seconds");
    }
